...
const miniatura =
    document.getElementById("miniaturaCaptura");
...
/*
   Más opaco que la versión anterior.
*/
...
/*
   Contorno completo de MediaPipe Face Mesh.
*/
...
function dibujarSegmentoRelleno(
    a,
    b,
    c,
    ancho
...
function dibujarMano(
    ...
    */
    ...
    /*
       Cada dedo se convierte
       visualmente en una rama gruesa.
    */
